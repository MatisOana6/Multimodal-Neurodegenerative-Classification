...
source_root = r"D:/Licenta/Datasets/ADNI_Oficial/Sorted/Axial"
target_root = r"D:/Licenta/Datasets/ADNI_Oficial/Converted/Axial"
resize_dim = (224, 224)
num_slices = 20  
...
def convert_patient_folder(patient_path, output_dir, class_name, patient_id):
    ...
    for i, (_, dicom_path) in enumerate(selected_files):
        try:
            ...
            output_name = f"Axial_{class_name}_{patient_id}_slice{i+1}.png"
